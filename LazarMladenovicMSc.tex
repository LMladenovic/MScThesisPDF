...
Objekti podudaranja sadrže ono što se poklopilo sa navedenim regularnim izrazom, što se u okviru \textit{if} izraza, kao takvo, tretira kao logička vrednost \textit{True}. Ukoliko nije bilo podudaranja, funkcije \textit{match()} i \textit{search()} vraćaju \textit{None}. 
