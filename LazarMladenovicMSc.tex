...
\apstr{
Verifikacija softvera zauzima bitno mesto u procesu razvoja softvera. Dinamička verifikacija softvera zasniva se na proveri ispravnosti softvera koja se vrši tokom njegovog izvršavanja. Postoje razni alazi za dinamičku verifikaciju softvera, a jedan od njih je \textit{Valgrind}. Alati njegove distribucije mogu dati profile programa koji mogu pomoći u poboljšanju rada i performansa programa, a takođe mogu i ukazati na greške u okviru programa koji nije lako otkriti. Jedan od alata jeste \textit{Memcheck}, koji analizira i ukazuje na greške u radu sa memorijom. Te greške mogu biti korišćenje neinicijalizovane vrednosti, pristup oslobođenoj, odnosno nedozvoljenoj memoriji i sl., a koje mogu da izazovu pad programa. 

Cilj ovog rada jeste konstrukcija alata koji bi koristeći izvešataj koji je dao\textit{Valgrind}, odnosno \textit{Memcheck}, otkrio greške u programu koji je analiziran, a zatim koristeći implementirane šablone za ispravljanje grešaka iste i ispravio. Dakle, osnovna namera rada jeste razumevanje izveštaja koji dobijamo iz alata \textit{Memcheck} i njegova primena za automatsko ispravljanje grešaka koristeći precizno tipizirane šablone za ispravljanje istih, koji će takođe biti implementirani. 
}
